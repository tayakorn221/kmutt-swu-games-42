...
> ผลอย่างเป็นทางการครบทุกแมตช์ถูกบันทึกไว้ใน `data.js` เมื่อ 5 ส.ค. 2569 · เว็บไม่ดึงสดจากต้นทางอีกแล้ว
...
8. **🏁 ปิดเล่มเป็น archive (5 ส.ค. 2569)** — ขูดผลรอบสุดท้ายมาแช่ลง `data.js`/Excel/CSV
...
ตอนแข่งเว็บอัปเดตอัตโนมัติทุก ~3 นาที · **ชุดข้อมูลปัจจุบันคือ snapshot ผลจบ ขูดครั้งสุดท้ายเมื่อ 5 ส.ค. 2569** — ตรึงไว้แล้ว ไม่เปลี่ยนอีก
